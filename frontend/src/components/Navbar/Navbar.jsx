                ...
                {!isLoggedIn &&
                    <div className="flex flex-col gap-4 items-center md:flex-row">
                        ...
                        <NavLink onClick={closeMenu} to='/signup'>
                            <button className="transition-all duration-300 hover:scale-105 bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-400 hover:to-blue-600 text-white px-4 py-2 rounded-md shadow-md">
                                Signup
                            </button>
                        </NavLink>
                    </div>
