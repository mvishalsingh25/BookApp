        ...
        <div className="min-h-screen bg-gray-900 text-gray-200 p-8">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center mb-16 space-y-8 md:space-y-0 md:space-x-12">
                ...
                <div className="text-center md:text-left">
                    ...
                    <p className="text-lg text-gray-300">
                        Our bookstore was founded by Vishal SIngh, a lifelong reader and passionate advocate for the literary community. Jane’s vision is to create a space where books ignite the imagination and inspire learning.
                    </p>
                </div>
            </div>
            ...
            <div className="flex justify-center space-x-6 mt-12">
                <div className=" flex flex-row">
                    <a  href="" className=" text-blue-600 hover:text-blue-500 flex items-center gap-1  transition">
                        <FaLinkedin className="text-gray-300" /> Linkedin
                    </a>
                </div>
                <a href="" className="text-blue-500 flex items-center hover:text-blue-500 gap-1 transition">
                    <FaSquareXTwitter className=" text-b" /> Twitter
                </a>
                <a href="" className="text-blue-500 flex items-center gap-1 hover:text-blue-500 transition">
